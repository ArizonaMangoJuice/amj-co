    ...
    return (
        <section className='history'>
            <section className='history-image'>
                ...
                <img className='image-2 history-image-block' src='https://images.unsplash.com/photo-1505855796860-aa05646cbf1f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1500&q=80'/>
            </section>
            <section className='history-text'>
                <h1 className='history-h1'>Velit velit voluptate nostrud proident sunt enim pariatur in.</h1>
